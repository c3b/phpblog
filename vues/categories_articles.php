	<?php
		$categorieArticle = intval(htmlentities($_GET['categorie_article']));
		
	?>


	<ul>
	<?php foreach (Articles::listArticlesByCategorie($categorieArticle) as $article):?>
		<div class="row">
			<div class="fondarticle">
				<h3><a href="index.php?article=<?= $article->id ?>"><?php echo $article->titre ?></a></h3>
				<h4>catégorie: <b><?= Categories::getCategorie($categorieArticle)->titre ?></b></h4>
